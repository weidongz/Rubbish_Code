...
public:
  ...
  */
  ...
  /**
   * Edited by Weidong, to obtain the lr-wpan state
   */
...
private:
  ...
  bool m_existLrWpanPhy;		//edited by Weidong, to show the existence of LrWpan
  Ptr<LrWpanPhy> m_LrWpanPhy;   //edited by Weidong,to get the LrWpanPhy
