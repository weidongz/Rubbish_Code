...
# with size=64 and three label
# Xd = cPickle.load(open("mixed_signal_n200000_fft_size_1024.pickle", 'rb'))
# labels_zigbee = cPickle.load(open('mixed_signal_three_label_n200000.pickle','rb'))
# Xd = cPickle.load(open("mixed_signal_n3112032_fft_size_64.pickle", 'rb'))
# labels_zigbee = cPickle.load(open('mixed_signal__three_label_n3112032_fft_size_64.pickle','rb'))
...
filepath = 'Data/network_weights/deep_num'+str(n_examples)+'_size'+str(fft_size)+'.wts.h5'
